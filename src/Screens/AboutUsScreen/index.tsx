    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Commissioned amidst the pandemic, our hospital in Kankarbagh, Patna
            has already treated thousands!{'\n\n'}
            Reach us at:
            {'\n'}📧 info@mediversal.in
        ...
        <View style={styles.card}>
          ...
          <View style={styles.memberBlock}>
            ...
            <Text style={styles.body}>
              Marine Engineering graduate, MDI Gurgaon and ESCP London alumnus,
              with experience in BP Shipping, Arcelor Mittal, Tata Steel. Serial
              entrepreneur in Agri & Healthcare sectors.
            </Text>
          </View>
          ...
          <View style={styles.memberBlock}>
            ...
            <Text style={styles.memberTitle}>Co-Founder & Director</Text>
            <Text style={styles.body}>
              Marine Engineering graduate, IIM Lucknow alumnus. Worked with NYK,
              Accenture, TTSL, HSBC. Brings digital transformation and strategy
              expertise from working with global & government orgs.
            </Text>
          </View>
