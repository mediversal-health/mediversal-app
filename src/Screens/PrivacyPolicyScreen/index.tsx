      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.body}>
              Credit card payments are processed by a secure third-party
              provider. We do not store card details and follow industry
              security standards.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.body}>
              We use advanced encryption and password protection, but no method
              is 100% secure. Users are advised to safeguard their credentials,
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.body}>
              ...
              prescriptions to improve our service. This is considered
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.body}>
              We may disclose information to comply with legal requests or
              protect rights. Financial info is handled securely via third-party
              gateways, and we’re not liable for their actions.
            </Text>
          </View>
